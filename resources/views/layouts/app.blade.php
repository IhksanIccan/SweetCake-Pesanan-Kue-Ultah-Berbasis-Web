...
<head>
    <style>
        ...
        .border-left-primary {
            border-left: 0.25rem solid #C60808 !important;
        }
    </style>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #C60808;">
            ...
            {{-- <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SweetCake</div>
            </a> --}}
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/dashboard')}}">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="Sweetcake/assets/img/removebg.png" alt="Kue" style="width: 40px; height: 40px;">
                </div>
                <div class="sidebar-brand-text mx-3">SweetCake</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{asset('startbootstrap-sb-admin-2-gh-pages')}}/img/undraw_profile.svg">
                            </a>
